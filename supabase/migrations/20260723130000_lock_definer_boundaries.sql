...
END $$;
DO $$ BEGIN
  IF to_regprocedure('public.apply_standard_rls(text)') IS NOT NULL THEN
    ALTER FUNCTION public.apply_standard_rls(text) SET search_path = pg_catalog, public, pg_temp;
  END IF;
END $$;
DO $$ BEGIN
  IF to_regprocedure('public.approve_contract(uuid, uuid, text, text)') IS NOT NULL THEN
    ALTER FUNCTION public.approve_contract(uuid, uuid, text, text) SET search_path = pg_catalog, public, pg_temp;
  END IF;
END $$;
DO $$ BEGIN
  IF to_regprocedure('public.auto_create_task_from_followup()') IS NOT NULL THEN
...
END $$;
DO $$ BEGIN
  IF to_regprocedure('public.check_milestone_order()') IS NOT NULL THEN
...
END $$;
DO $$ BEGIN
  IF to_regprocedure('public.get_team_activity(date)') IS NOT NULL THEN
    ALTER FUNCTION public.get_team_activity(date) SET search_path = pg_catalog, public, pg_temp;
  END IF;
END $$;
DO $$ BEGIN
  IF to_regprocedure('public.handle_auth_login()') IS NOT NULL THEN
...
END $$;
DO $$ BEGIN
  IF to_regprocedure('public.sync_lead_next_followup()') IS NOT NULL THEN
    ALTER FUNCTION public.sync_lead_next_followup() SET search_path = pg_catalog, public, pg_temp;
  END IF;
END $$;
DO $$ BEGIN
  IF to_regprocedure('public.sync_task_from_lead()') IS NOT NULL THEN
    ALTER FUNCTION public.sync_task_from_lead() SET search_path = pg_catalog, public, pg_temp;
  END IF;
END $$;
DO $$ BEGIN
  IF to_regprocedure('public.sync_user_email_to_profile()') IS NOT NULL THEN
