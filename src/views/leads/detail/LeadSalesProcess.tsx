...
import { COMPLETABLE_MILESTONES } from "@/services/milestones";
import { calculateHealthScore } from "@/services/health-score";
import { STAGES, STAGE_COLORS } from "@/views/leads/detail/types";
import { fmtAED, daysSince } from "@/views/leads/detail/utils";
import type {
  Lead,
  LeadTrace,
  LeadMilestone,
