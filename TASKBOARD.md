...
| hermes-ci | Hermes CI webhook 订阅 crm-ci | CI pipeline 跑通 + webhook 触发 | GitHub Actions `crm-ci` workflow + `docs/ops/hermes-ci-webhook.md` delivery contract | ✅ 2026-07-10 |
