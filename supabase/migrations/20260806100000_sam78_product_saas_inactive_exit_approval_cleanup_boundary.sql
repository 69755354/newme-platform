...
-- Product/SaaS UAT deliberately deactivates its synthetic admin and boss
-- before exercising the customer-exit flow.  The cleanup predicate must
-- therefore preserve the full synthetic approval boundary without treating
-- those two expected inactive profiles as non-synthetic evidence.
