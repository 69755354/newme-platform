-- The Product/SaaS UAT deliberately deactivates its exact synthetic admin
-- before cleanup. Keep the strict marker/plan/seat/role/member boundary, but
-- do not make cleanup depend on an account that the same UAT has retired.
BEGIN;
