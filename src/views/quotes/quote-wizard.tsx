...
import { DEVICE_CATALOG, findDevice, QUOTATION_DEFAULTS } from "@/services/device-catalog";
import { calculateQuotation, type CalculateResult } from "@/services/quotation-engine";
