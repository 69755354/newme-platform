...
const DEFAULT_CHECKS = [
  ...
  },
  {
    ...
    forbidden: [
      "1612447067166445",
      "https://app.newme.ae/api/meta/oauth-callback",
    ],
  },
  {
    id: "meta-oauth-bounded-delivery",
  ...
  {
    id: "enabled-integration-runtime-policies",
    file: "src/lib/integration-execution.mjs",
    patterns: [
      "meta_oauth",
      "meta_capi",
      "in_app_notification",
  ...
  {
    id: "webhook-cron-audit-alert-contract",
    files: [
