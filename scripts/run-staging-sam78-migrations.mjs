...
export const MIGRATIONS = Object.freeze([
  ...
  Object.freeze({
    ...
    migrationEnv: "SAM83_MIGRATION_060200_PATH",
    migrationBlobEnv: "SAM83_MIGRATION_060200_BLOB",
    rollbackEnv: "SAM83_ROLLBACK_060200_PATH",
    rollbackBlobEnv: "SAM83_ROLLBACK_060200_BLOB",
  }),
  Object.freeze({
    version: "20260806030000",
    name: "sam83_v4_synthetic_cleanup_marker_case",
    migrationEnv: "SAM83_MIGRATION_060300_PATH",
    migrationBlobEnv: "SAM83_MIGRATION_060300_BLOB",
    rollbackEnv: "SAM83_ROLLBACK_060300_PATH",
    rollbackBlobEnv: "SAM83_ROLLBACK_060300_BLOB",
  }),
  Object.freeze({
    version: "20260806040000",
    name: "sam84_v4_synthetic_gateway_cleanup_boundary",
    migrationEnv: "SAM84_MIGRATION_060400_PATH",
    migrationBlobEnv: "SAM84_MIGRATION_060400_BLOB",
    rollbackEnv: "SAM84_ROLLBACK_060400_PATH",
    rollbackBlobEnv: "SAM84_ROLLBACK_060400_BLOB",
  }),
  Object.freeze({
    version: "20260806050000",
    name: "sam82_v4_synthetic_inventory_cleanup_boundary",
    migrationEnv: "SAM82_MIGRATION_060500_PATH",
    migrationBlobEnv: "SAM82_MIGRATION_060500_BLOB",
  ...
  Object.freeze({
    ...
    migrationEnv: "SAM78_MIGRATION_060700_PATH",
    migrationBlobEnv: "SAM78_MIGRATION_060700_BLOB",
    rollbackEnv: "SAM78_ROLLBACK_060700_PATH",
    rollbackBlobEnv: "SAM78_ROLLBACK_060700_BLOB",
  }),
  Object.freeze({
    version: "20260806080000",
    name: "sam78_product_saas_inactive_admin_cleanup_boundary",
    migrationEnv: "SAM78_MIGRATION_060800_PATH",
    migrationBlobEnv: "SAM78_MIGRATION_060800_BLOB",
    rollbackEnv: "SAM78_ROLLBACK_060800_PATH",
    rollbackBlobEnv: "SAM78_ROLLBACK_060800_BLOB",
  }),
  Object.freeze({
    version: "20260806090000",
    name: "sam78_product_saas_billable_seat_cleanup_boundary",
    migrationEnv: "SAM78_MIGRATION_060900_PATH",
    migrationBlobEnv: "SAM78_MIGRATION_060900_BLOB",
    rollbackEnv: "SAM78_ROLLBACK_060900_PATH",
    rollbackBlobEnv: "SAM78_ROLLBACK_060900_BLOB",
  }),
  Object.freeze({
    version: "20260806100000",
    name: "sam78_product_saas_inactive_exit_approval_cleanup_boundary",
    migrationEnv: "SAM78_MIGRATION_061000_PATH",
    migrationBlobEnv: "SAM78_MIGRATION_061000_BLOB",
    rollbackEnv: "SAM78_ROLLBACK_061000_PATH",
    rollbackBlobEnv: "SAM78_ROLLBACK_061000_BLOB",
  }),
  Object.freeze({
    version: "20260806110000",
    name: "sam78_product_saas_exit_staff_ref_cleanup_boundary",
    migrationEnv: "SAM78_MIGRATION_061100_PATH",
    migrationBlobEnv: "SAM78_MIGRATION_061100_BLOB",
    rollbackEnv: "SAM78_ROLLBACK_061100_PATH",
    rollbackBlobEnv: "SAM78_ROLLBACK_061100_BLOB",
  }),
  Object.freeze({
    version: "20260806120000",
    name: "sam78_organizations_selected_context_read_boundary",
    migrationEnv: "SAM78_MIGRATION_061200_PATH",
    migrationBlobEnv: "SAM78_MIGRATION_061200_BLOB",
    rollbackEnv: "SAM78_ROLLBACK_061200_PATH",
    rollbackBlobEnv: "SAM78_ROLLBACK_061200_BLOB",
  }),
]);
