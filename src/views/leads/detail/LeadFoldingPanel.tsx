...
import LeadContractsPanel from "@/views/leads/detail/LeadContractsPanel";
import { fmtAED } from "@/views/leads/detail/utils";
import type { Lead, RenderJsonEdit } from "@/views/leads/detail/types";
