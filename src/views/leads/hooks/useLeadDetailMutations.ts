...
import { MILESTONE_LABELS, MILESTONE_DESCRIPTIONS } from "@/services/milestones";
import { createFollowUpTask } from "@/services/tasks";
import { projectDraftFromLead } from "@/views/leads/detail/utils";
import type { Lead, Task } from "@/views/leads/detail/types";
import type { ProjectInfoDraft } from "@/views/leads/hooks/useLeadDetailData";
