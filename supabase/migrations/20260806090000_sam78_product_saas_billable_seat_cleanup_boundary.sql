-- The Product/SaaS runner provisions exactly 20 billable seats.  Preserve the
-- marker, organization, actor and membership predicates while making cleanup
-- match that immutable fixture contract.
BEGIN;
...
AS $$
  SELECT EXISTS (
    ...
    WHERE organization.id = p_organization_id
      ...
      AND organization.billable_seat_limit = 20
