...
| `tests/security/sam22-two-organization-isolation.test.mjs` | `e0a28c7964c2d9da19c806b1aa2c1e51e3ab1d35` | SAM-22 静态双组织合同与 marker residue 清理 |
| `src/types/database.ts` | `e9d61148be68baf1bc828999fa0728d27baf3bf1` | canonical 生成类型中可见的表、列和关系 |
